            ...
            for($i=0;$i<$numrows;$i+=2){
                  $j=$i+1;
                      if($j<$numrows){
                        echo "
                          <div class='rowItem'>
                            <div class='singleItem'> <img src= $arr3[$i] class='itemImage'> <div class='itemName'> $arr1[$i] </div> <div class='itemPrice'><br> Php$arr2[$i] <div class='orderButtonDiv'><a href='purchaseItem.php?itemid=$arr4[$i]'>ORDER</a></div> </div></div>
                            <div class='singleItem'> <img src= $arr3[$j] class='itemImage'> <div class='itemName'> $arr1[$j] </div> <div class='itemPrice'><br> Php$arr2[$j] <div class='orderButtonDiv'><a href='purchaseItem.php?itemid=$arr4[$j]'>ORDER</a></div> </div></div>
                          </div>";
                      }
                      else{
                        echo "
